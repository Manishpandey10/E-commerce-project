...
<body>
    ...
    <form method="POST" action="{{ route('verify.front') }}" id="loginForm">
            ...
            <div class="auth-wrapper v3">
                <div class="auth-form">
                    <div class="auth-header">
                        <a href="{{ route('front.login') }}"><img src="{{ url('/assets/images/logo-dark.svg') }}" alt="img"></a>
                    </div>
                    <div class="card my-5">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-end mb-4">
                                <h3 class="mb-0"><b>User Login</b></h3>
                                <a href="{{ route('front.signup') }}" class="link-primary">Don't have an account?</a>
                            </div>

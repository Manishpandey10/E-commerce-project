...
<body>
    ...
    <!-- [ Pre-loader ] End -->
    <form id = "signupForm" action="{{ route('register.front.user') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="auth-main">
                    ...
                    <div class="card my-5">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-end mb-4">
                                ...
                                <a href="{{ route('front.login') }}" class="link-primary">Already have an account?</a>
                            </div>
                            <div class="row">
                                <div class="col-12">
